...
# 2️⃣ Generate AndroidManifest.xml without 'package' to match Gradle namespace
...
# 3️⃣ Create build.gradle files with namespace, plugin, and repositories
...
# 6️⃣ Generate sprites using ImageMagick
